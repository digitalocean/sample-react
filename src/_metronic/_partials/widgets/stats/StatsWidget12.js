...
function getChartOption(layoutProps) {
  var options = {
    series: [
      {
        ...
        data: [17482, 17343, 12436, 12111, 14146, 14853, 19832]
      }
    ],
    chart: {
      type: "area",
    ...
    xaxis: {
      categories: ["10AM", "11AM", "12PM", "01PM", "02PM", "03PM", "04PM"],
      axisBorder: {
        show: false
      },
      axisTicks: {
...
export function StatsWidget12({ className }) {
  ...
  return (
    <div className={`card card-custom audiance-chart ${className}`}>
      <div className="card-body d-flex flex-column p-0">
        <div className="d-flex align-items-center justify-content-between card-spacer flex-grow-1">
          ...
          <div className="d-flex flex-column text-right">
            ...
            <span className="text-muted font-weight-bold mt-2">Audience Reached</span>
          </div>
        </div>
        <div
